...
def staff():
    ...
    l1=Label(window,text="consultation Fee").place(x=240,y=390)
    l2=Label(window,text="Medication fee").place(x=240,y=430)
    l3=Label(window,text="Medical reports'fee").place(x=240,y=470)
    ma=Entry(window)
    ...
    button = Button(window, text='Submit details', bd=10,width=25,bg = "black",fg ="teal",command=submitt).place(x=300,y=600)
